...
num.chicken=1000
num.dog=1000
label_train=c(rep(0,num.chicken),rep(1,num.dog)) #length=2000
...
########### my change #################
# feature base
tm_feature_train_base=system.time(dat_train_base <- feature_base('sift_features.csv'));dim(dat_train)
# feature RGB
tm_feature_train_RGB.dog=system.time(dat_train_RGB <- feature_RGB(img_train_dir, "dog"))
tm_feature_train_RGB.chic=system.time(dat_train_RGB <- feature(img_train_dir, "chicken"))
tm_feature_train_RGB=system.time(dat_train_RGB <- feature(img_train_dir, c("chicken','dog")))
