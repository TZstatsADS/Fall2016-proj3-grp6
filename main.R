...
dat_train_RGB=dat_train_RGB[,which(colSums(dat_train_RGB)!=0)];dim(dat_train_RGB)
dat_train=cbind(dat_train_base,dat_train_RGB);dim(dat_train)
tm_feature_train = tm_feature_train_base+tm_feature_train_RGB;tm_feature_train
